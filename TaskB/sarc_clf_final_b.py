...
df_given = pd.read_csv("SemEval2018-T3-train-taskB_emoji.txt", sep="\t")
...
X_train, X_test, y_train, y_test = train_test_split(X_given, to_categorical(y_given), random_state=42)
...
first_dense = Dense(4, activation='softmax')(second_lstm)
...
print("Precision:", precision_score(y_test, y_test_predicted, average="macro"))
print("Recall:", recall_score(y_test, y_test_predicted, average="macro"))
print("f1:", f1_score(y_test, y_test_predicted, average="macro"))
