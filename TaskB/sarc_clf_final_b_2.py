...
df_test = pd.read_csv("SemEval2018-T3_input_test_taskB_emoji.txt", sep="\t")
y_train = to_categorical(np.asarray(list(df_given['Label'])))
...
list_to_file(y_test_predicted, "task_B_predictions_ASDT.txt")
